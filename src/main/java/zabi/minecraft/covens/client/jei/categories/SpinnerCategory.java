...
public class SpinnerCategory implements IRecipeCategory<SpinnerWrapper> {
	...
	public static final String UID = Reference.MID+":spinner";
	
	public SpinnerCategory(IGuiHelper igh) {
		bg = igh.createDrawable(new ResourceLocation(Reference.MID, "textures/gui/jei_spinner.png"), 0, 0, 90, 36, 90, 36);
	}
