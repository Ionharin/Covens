...
public class ModSpells {
	...
	public static void registerAll() {
		...
		infuse_life = new SpellInfuseLife(0xf6546a, EnumSpellType.PROJECTILE_ALL, "infuse_life", Reference.MID);
		self_heal = new SpellSelfHeal(0xd20057, EnumSpellType.INSTANT, "self_heal", Reference.MID);
	}
