...
public class ItemCardinalStone extends Item {
	...
	public void addInformation(ItemStack stack, World worldIn, List<String> tooltip, ITooltipFlag flagIn) {
		...
		if (pos.hasKey("x")) {
			...
			tooltip.add(TextFormatting.GRAY + TextFormatting.ITALIC.toString() + I18n.format("item.cardinal_stone.unbound"));
		} else if (stack.getMetadata()==0) {
			tooltip.add(TextFormatting.GRAY + TextFormatting.ITALIC.toString() + I18n.format("item.cardinal_stone.uncharged"));
		}
	}
